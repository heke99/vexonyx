...
const groups = [
  ...
  },
  {
    ...
    items: [
      ...
      ["/admin/inference", "AI requests", "✦"],
      ["/admin/agents", "Agent runs", "⌁"],
      ["/admin/jobs", "Jobs", "≋"],
    ...
    <div className="admin-shell">
          ...
          {groups.map((group) => (
            <div className="admin-nav-group" key={group.label}>
              ...
              {group.items.map(([href, label, icon]) => (
                <Link href={href} key={href} className="admin-nav-link">
      ...
      <main className="admin-main">
        <header className="admin-topbar">
          ...
          <div className="admin-topbar-links"><Link href="/">View website</Link><Link href="/app">Open workspace</Link></div>
        </header>
        {children}
      </main>
    </div>
