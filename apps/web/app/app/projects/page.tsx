...
export default async function Page() {
  ...
  return <div className="app-content">
    <div className="app-heading"><div><h1>Projects</h1><p>Authorized security workspaces with scope, files, notes, findings, evidence and reports kept together.</p></div><Link className="button button-small secondary" href="/app/projects/deleted">Deleted projects</Link></div>
