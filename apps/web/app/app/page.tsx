...
export default async function DashboardPage() {
  ...
  return <div className="app-content">
    <div className="app-heading"><div><h1>Security workspace</h1><p>Your live project data in one place. Dashboard numbers always come from your workspace.</p></div><Link className="button button-small" href="/app/chat">New chat</Link></div>
    ...
    <section className="workspace-grid">
      ...
      <article className="workspace-card"><header><h2>Agent activity</h2><Link href="/app/agents">View runs →</Link></header><div className="empty-state"><div><b>Ready for private AI connection.</b><p>Projects, authorization, progress tracking and recovery state are prepared before any model is connected. External actions remain off until explicitly enabled.</p></div></div></article>
    </section>
  </div>;
}
